        ...
        <div className="row">
          <div className="col-md-4 mb-5">
            ...
            <div className="d-flex flex-column justify-content-start">
              <Link className="text-dark mb-2" to="/" ><i className="fa fa-angle-right mr-2" />Home</Link>
              <Link className="text-dark mb-2" to="/categories" ><i className="fa fa-angle-right mr-2" />Our Shop</Link>
              <Link className="text-dark mb-2" to="/cart" ><i className="fa fa-angle-right mr-2" />Shopping Cart</Link>
              <Link className="text-dark mb-2" to="/userdetails" ><i className="fa fa-angle-right mr-2" />User</Link>
              <Link className="text-dark" to="/contact" ><i className="fa fa-angle-right mr-2" />Contact Us</Link>
            </div>
          </div>
          <div className="col-md-4 mb-5">
